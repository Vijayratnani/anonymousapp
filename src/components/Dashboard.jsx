        ...
        <div className='mt-10 mb-10'>
          ...
          <div className='flex items-center justify-center flex-wrap h-4/5'>
            <div className="p-2 w-full lg:w-1/2 bg-cover bg-center h-1/3 ">
                <img src={male} type="img/jpg" alt="Code" className='h-auto max-w-11/12 block w-full border-none
                border-r lg:border-dashed border-neutral-500 '/>
                <p className='text-center m-5 mb-10'>12000 MALE STUDENT</p>
            </div>
            <div className="p-2 w-full overflow-hidden h-full lg:w-1/2 bg-cover bg-center ">
                <img src={female} type="img/jpg" alt="Code" className='h-auto max-w-11/12 block w-11/12'/>
